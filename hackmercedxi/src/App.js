...
var questionTypes = Array("MC", "MC", "MC", "SL", "MC", "MC", "MC", "MC", "MC", "MC", "MC", "MC", "MC", "SL", "SL", "MC", "MC", "SL", "MC", "MC"); //MC for multiple choice, SL for slider
const questionParameters = [
  {name:"Questions 1: Do you have a high bloood pressure?", options:3, values: Array("yes", "no", "prefer not to say - questions will be disregarded - may lower accuracy")},
    ...
    {name:"Questions 11: Do you have any health care coverage, indlucing health insurance and prepaid plans such as HMO?", options:3, values: Array("yes", "no", "prefer not to say")},
    {name:"Questions 12: Was there a time in the past 12 months when you neeeded to see a doctor but could not because of cost?", options:3, values: Array("yes", "no", "prefer not to say")},
    {name:"Questions 13: How well would you say that your general health is(1 being excelent, 5 being poor)?", options: 5, values: Array("1", "2", "3", "4", "5")},
    {name:"Questions 14: Now thinking about your mental health, which includes stress, depression, and problems with emotions, for how many days during the past 30 days was your mental health not good? scale 1-30 days", max:30, min:1},
    {name:"Questions 15: Now thinking about your physical health, which includes physical illness and injury, for how many days during the past 30 days was your physical health not good? scale 1-30 days", max:30, min:1},
    {name:"Questions 16: Do you have difficulty climbing or walking up the stairs?", options:3, values: Array("yes", "no", "prefer not to say")},
    {name:"Questions 17: Is your sex male or female?", options:3, values: Array("male", "female", "prefer not to say")},
    {name:"Questions 18: How old are you?", max:100, min: 1},
    {name:"Questions 19: what is your education?", options:7, values: Array("none or just kindergarten", "1st-8th", "highschool", "Associate's", "4 year degree college/university", "secondary education", "prefer not to say")},
    {name:"Questions 20: how much income does your household make? (1 <$10,000; 5 < $35,000; 8 >= $75,000", options:8, values: Array("1", "2", "3", "4", "5", "6", "7", "8")}
];
